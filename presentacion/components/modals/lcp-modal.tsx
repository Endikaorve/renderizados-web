  ...
  return (
    ...
    >
      <p className="text-slate-700 dark:text-slate-300">
        El Largest Contentful Paint (LCP) es una métrica de rendimiento web que
        mide el tiempo que tarda en renderizarse el elemento de contenido más
        grande visible en la ventana (viewport) inicial. Es considerada una de
        las Core Web Vitals de Google y un indicador clave de la experiencia de
        usuario percibida.
      </p>
      ...
      <ul className="space-y-2">
        <li className="text-slate-700 dark:text-slate-300">
          Representa cuándo el usuario percibe que la mayor parte del contenido
          está cargado
        </li>
        <li className="text-slate-700 dark:text-slate-300">
        ...
        <li className="text-slate-700 dark:text-slate-300">
          Impacta directamente en el SEO, ya que es un factor de ranking para
          Google
        </li>
      </ul>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mt-6">
        <p className="text-slate-700 dark:text-slate-300 text-sm">
          Estrategias como SSG, Streaming y PPR están diseñadas para optimizar
          el LCP al priorizar la entrega rápida del contenido principal.
        </p>
      </div>
    </ConceptModal>
  );
